              ...
              <div className="col-12 col-sm-6 col-xl-3">
                <div className="card border-0 border-bottom border-primary shadow-sm"  style={{height: '60vh', backgroundColor: '#d4d9f7'}}>
                  <div className="card-body text-center p-4 p-xxl-5">
                    ...
                    <h4 className="mb-4" style={{fontWeight:'bolder'}}>Social Engagement</h4>
                    
                    <p className="mb-4 text-secondary">
                      Vestibulum bibendum, lorem a blandit lacinia, nisi velit
                      posuere nisl, vel placerat magna mauris mollis maximus
                      est.
                    </p>
                    <a
                      href="#!"
              ...
              <div className="col-12 col-sm-6 col-xl-3">
                <div className="card border-0 border-bottom border-primary shadow-sm" style={{height: '60vh', backgroundColor: '#d4d9f7'}}>
                  <div className="card-body text-center p-4 p-xxl-5">
                    ...
                    <h4 className="mb-4" style={{fontWeight:'bolder'}}>Mobile Design</h4>
                    <p className="mb-4 text-secondary">
                      Vestibulum bibendum, lorem a blandit lacinia, nisi velit
                      posuere nisl, vel placerat magna mauris mollis maximus
                      est.
              ...
              <div className="col-12 col-sm-6 col-xl-3">
                <div className="card border-0 border-bottom border-primary shadow-sm" style={{height: '60vh', backgroundColor: '#d4d9f7'}}>
                  <div className="card-body text-center p-4 p-xxl-5">
                    ...
                    <h4 className="mb-4" style={{fontWeight:'bolder'}}>SEO Services</h4>
                    <p className="mb-4 text-secondary">
                      Vestibulum bibendum, lorem a blandit lacinia, nisi velit
                      posuere nisl, vel placerat magna mauris mollis maximus
                      est.
              ...
              <div className="col-12 col-sm-6 col-xl-3">
                <div className="card border-0 border-bottom border-primary shadow-sm" style={{height: '60vh', backgroundColor: '#d4d9f7'}}>
                  <div className="card-body text-center p-4 p-xxl-5">
                    ...
                    <h4 className="mb-4" style={{fontWeight:'bolder'}}>24/7 Support</h4>
                    <p className="mb-4 text-secondary">
                      Vestibulum bibendum, lorem a blandit lacinia, nisi velit
                      posuere nisl, vel placerat magna mauris mollis maximus
                      est.
