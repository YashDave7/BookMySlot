                  ...
                  What We Do?
                    ...
                    <div className="col-12 col-md-6">
                        ...
                        <div className="me-4 text-primary">
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#9AA4EC" className="bi bi-gear-fill" viewBox="0 0 16 16" style={{paddingRight:'10px' }} >
                    ...
                    <div className="col-12 col-md-6">
                        <div className="d-flex">
                        <div className="me-4 text-primary">
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#9AA4EC" className="bi bi-fire" viewBox="0 0 16 16" style={{paddingRight:'10px' }} >
